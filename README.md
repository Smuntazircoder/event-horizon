...
Event Horizon is a full-stack event discovery and management platform. It includes location-aware event search, AI-style natural language search, JWT authentication, roles, event creation, registration, bookmarks, admin stats, PostgreSQL/Prisma persistence, and responsive React UI build by skcoder .
